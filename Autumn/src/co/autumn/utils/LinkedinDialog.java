...
//		setContentView(R.layout.linkedin_dialog);
//
//		setWebView();
//	}
//
...
//				.createLinkedInOAuthService(LINKEDIN_API_KEY, LINKEDIN_SECRET_KEY);
//		
...
//				.getOAuthRequestToken(LINKEDIN_OAUTH_CALLBACK_URL);
//
//		WebView mWebView = (WebView) findViewById(R.id.webkitWebView);
...
//			if (url.contains(LINKEDIN_OAUTH_CALLBACK_URL)) {
